...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:n+t+"$"}]}}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
...
endsParent:!0}]}]}}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";function e(...e){
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
end:/$/}]})})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("aspectj",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
