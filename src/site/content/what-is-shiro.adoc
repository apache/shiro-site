...
:jbake-description: Discover what Apache Shiro is - a Java security framework providing authentication, authorization, session management and cryptography with a mission to make security easy.
:idprefix:
