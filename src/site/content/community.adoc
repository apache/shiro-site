...
:jbake-description: Join the Apache Shiro community to get help, share knowledge, and contribute. Access forums, mailing lists, articles, and community events.
:idprefix:
...
* *https://github.com/apache/shiro/discussions[GitHub Discussions]* - Need help? Ask questions and discuss ideas with the community
