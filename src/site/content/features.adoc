...
:jbake-description: Overview of Apache Shiro's key features including pluggable authentication, role-based authorization, enterprise session management, and cryptographic services.
:idprefix:
:icons: font
