...
You can find portable JAX-RS application that runs with https://eclipse-ee4j.github.io/jersey/[Jersey], https://resteasy.dev/[RestEasy] or https://cxf.apache.org[Apache CXF] in the https://github.com/apache/shiro/tree/main/samples[samples] directory on GitHub.
