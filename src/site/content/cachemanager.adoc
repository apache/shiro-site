...
:jbake-description: Apache Shiro Cache Manager API overview covering the CacheManager, Cache, and CacheManagerAware interfaces for integrating caching into your security layer.
:idprefix:
