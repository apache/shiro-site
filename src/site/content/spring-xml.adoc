...
:jbake-description: Configure Apache Shiro with Spring XML configuration for standalone and web applications using Spring's IoC container.
:idprefix:
...
The easiest way to contribute your documentation is to send it to the link:mailing-lists.html[User Mailing List].
