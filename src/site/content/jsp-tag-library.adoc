...
:jbake-description: Apache Shiro JSP and GSP tag library reference for adding security controls to web pages including guest, user, role and permission tags.
:idprefix:
:icons: font
