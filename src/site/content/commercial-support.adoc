...
link:https://github.com/oktadev/okta-shiro-plugin[Learn More >>>]

== Yupiik

link:https://www.yupiik.com/[Yupiik] provides commercial support and consulting services for Apache Shiro and related projects.
