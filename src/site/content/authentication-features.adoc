...
:jbake-description: Overview of Apache Shiro authentication features including pluggable realms, remember-me support, and clean exception handling for identity verification.
:idprefix:
