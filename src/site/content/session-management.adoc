...
:jbake-description: Apache Shiro's enterprise session management provides POJO-based sessions that work in any environment, supporting clustering, expiration, and persistence without requiring a web container.
:idprefix:
:icons: font
:toc:
