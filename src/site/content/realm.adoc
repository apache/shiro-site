...
:jbake-description: Understanding Apache Shiro Realms - security-specific data access objects that connect your application's security data (users, roles, permissions) to the Shiro framework.
:idprefix:
:icons: font
:toc:
