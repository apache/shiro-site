...
:jbake-description: Quick reference list of Apache Shiro security annotations including @RequiresAuthentication, @RequiresRoles, @RequiresPermissions, and more.
:idprefix:
