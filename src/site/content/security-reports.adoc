...
**Credit:**
Apache Shiro would like to thank the following people for reporting this issue: *https://lzhou1110.github.io/[Liyi]*, *https://zyy0530.github.io/[Ziyue]*,
*https://str1ckl4nd.github.io/[Strick]*, *http://maurice.busystar.org/[Maurice]*, and *https://7thparkk.github.io/[Chenchen]*.
We would also like to thank *Andrea Cosentino* for finding a weakness in the remediation and reporting it to us.
...
This vulnerability is similar to link:https://www.cve.org/CVERecord?id=CVE-2020-1957[CVE-2020-1957], except that it affects the `shiro-guice` module instead of the `shiro-spring` module.
...
**Mitigation:**
Upgrade to version 2.2.1, or 3.0.0-alpha-2 or later, which fixes the issue by escaping user-supplied DN.
