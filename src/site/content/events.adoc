...
:jbake-description: Upcoming and past Apache Shiro community events, conferences, and meetups where you can learn about Shiro and connect with the community.
:idprefix:
:icons: font
:toc:
