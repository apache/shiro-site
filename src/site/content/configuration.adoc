...
:jbake-description: Learn how to configure Apache Shiro using INI files, programmatic configuration, or dependency injection frameworks for any Java application environment.
:idprefix:
:icons: font
:toc:
