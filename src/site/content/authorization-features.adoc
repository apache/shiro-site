...
:jbake-description: Overview of Apache Shiro authorization features including role-based and permission-based access control, annotations, and pluggable authorization modules.
:idprefix:
:icons: font
