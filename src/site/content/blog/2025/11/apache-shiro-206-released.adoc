...
The Apache Shiro team is pleased to announce the release of Apache Shiro version 2.0.6.
...
You can learn more on link:https://github.com/apache/shiro/releases/tag/shiro-root-2.0.6[GitHub, Release 2.0.6].
