...
For more information on Shiro 1.2, please read the "link:https://web.archive.org/web/20200521055904/https://stormpath.com/blog/whats-new-apache-shiro-12[What's new in Apache Shiro 1.2?]" [archive.org] article or the previous link:/blog/2012/01/24/apache-shiro-120-released.html[1.2 release announcement].
