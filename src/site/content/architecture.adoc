...
:jbake-description: Understand the Apache Shiro architecture including the core concepts of Subject, SecurityManager, and Realms, and how they work together to provide application security.
:idprefix:
