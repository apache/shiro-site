...
:jbake-description: Reference information for Apache Shiro committers and contributors including source code access, documentation guidelines, and development workflows.
:idprefix:
:icons: font
