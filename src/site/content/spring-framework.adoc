...
:jbake-description: Guide to integrating Apache Shiro with Spring Framework applications covering both annotation-based and XML configuration approaches.
:idprefix:
:toc:
